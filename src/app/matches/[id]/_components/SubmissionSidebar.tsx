...
export default function SubmissionSidebar({
  ...
  return (
    <div className="col-span-12 lg:col-span-4">
      <div className={cn(
        "p-8 rounded-[36px] border transition-all sticky top-[320px] md:top-[280px]",
        canSubmit ? "bg-emerald-600/10 border-emerald-500/30" : "bg-white/2 border-white/5"
      )}>
        <h3 className="font-display font-black text-xl uppercase tracking-tight italic mb-4">Submission Control</h3>
        
        <div className="flex gap-3 items-start p-4 rounded-2xl bg-black/40 border border-white/5 text-xs text-gray-400 font-medium leading-relaxed italic mb-6">
